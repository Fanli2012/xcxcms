...
class Keyword extends Base
{
    ...
    public function edit()
    {
        ...
        $this->assign('id',$id);
		$this->assign('row',db('keyword')->where("id=$id")->find());
    ...
    public function doedit()
    {
		...
		if(db('keyword')->where("id=$id")->update($_POST))
        {
    ...
    public function del()
    {
		...
		if(db("keyword")->where("id in ($id)")->delete())
        {
