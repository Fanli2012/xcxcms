...
class Goods extends Validate
{
    ...
    protected $rule = [
        ...
        ['type_id', 'require|number|gt:0','栏目ID必填|栏目ID必须是数字|栏目ID格式不正确'],
        ...
        ['comments', 'number|egt:0','评论次数必须是数字|评论次数格式不正确'],
        ...
        ['brand_id', 'number|egt:0', '商品品牌ID必须是数字|商品品牌ID格式不正确'],
    ...
    protected $scene = [
        'add'  => ['type_id', 'tuijian', 'click', 'title', 'seotitle', 'keywords', 'description', 'litpic', 'goods_img', 'sn', 'price', 'market_price', 'cost_price', 'shipping_fee', 'goods_number', 'sale', 'warn_number', 'goods_weight', 'point', 'comments', 'promote_price', 'promote_start_date','promote_end_date', 'brand_id', 'user_id', 'listorder', 'status', 'update_time', 'add_time'],
        'edit' => ['type_id', 'tuijian', 'click', 'title', 'seotitle', 'keywords', 'description', 'litpic', 'goods_img', 'sn', 'price', 'market_price', 'cost_price', 'shipping_fee', 'goods_number', 'sale', 'warn_number', 'goods_weight', 'point', 'comments', 'promote_price', 'promote_start_date','promote_end_date', 'brand_id', 'user_id', 'listorder', 'status', 'update_time'],
        'del'  => ['id'],
    ];
}