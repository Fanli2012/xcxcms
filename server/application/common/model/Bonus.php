...
class Bonus extends Base
{
    ...
    //状态：0可用，1不可用
    const BONUS_STATUS_AVAILABLE = 0;
    const BONUS_STATUS_UNAVAILABLE = 1;
    //状态描述
    public static $bonus_status_desc = array(
        self::BONUS_STATUS_AVAILABLE => '可用',
        self::BONUS_STATUS_UNAVAILABLE => '不可用'
    );
    ...
    {
        return self::$bonus_status_desc[$data['status']];
    }
