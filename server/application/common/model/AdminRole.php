...
class AdminRole extends Base
{
    ...
    //状态，0正常，1禁用
    const ADMIN_ROLE_STATUS_NORMAL = 0;
    const ADMIN_ROLE_STATUS_DISABLE = 1;
    //状态描述
    public static $admin_role_status_desc = [
        self::ADMIN_ROLE_STATUS_NORMAL => '正常',
        self::ADMIN_ROLE_STATUS_DISABLE => '禁用'
    ];
    ...
    {
        return self::$admin_role_status_desc[$data['status']];
    }
}