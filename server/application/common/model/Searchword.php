...
class Searchword extends Base
{
    ...
    //状态，0：正常，1：禁用
    const SEARCHWORD_STATUS_NORMAL = 0;
    const SEARCHWORD_STATUS_DISABLE = 1;
    //状态描述
    public static $searchword_status_desc = [
        self::SEARCHWORD_STATUS_NORMAL => '正常',
        self::SEARCHWORD_STATUS_DISABLE => '禁用'
    ];
    ...
    {
        return self::$searchword_status_desc[$data['status']];
    }
