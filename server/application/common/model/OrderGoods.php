...
class OrderGoods extends Base
{
    ...
    {
        return db('order_goods');
    }

    const ORDER_REFUND_STATUS_NORETURN = 0;
    const ORDER_REFUND_STATUS_REFUNDING = 1;
    const ORDER_REFUND_STATUS_SUCCESS = 2;
    const ORDER_REFUND_STATUS_REFUSE = 3;
