...
class UserBonus extends Base
{
    ...
    {
        return db('user_bonus');
    }

    //状态：0未使用1已使用2已过期
    const USER_BONUS_STATUS_UNUSED = 0;
    const USER_BONUS_STATUS_USED = 1;
    const USER_BONUS_STATUS_EXPIRED = 1;
    //状态描述
    public static $user_bonus_status_desc = array(
        self::USER_BONUS_STATUS_UNUSED => '未使用',
        self::USER_BONUS_STATUS_USED => '已使用',
        self::USER_BONUS_STATUS_EXPIRED => '已过期'
    );
    ...
    {
        return self::$user_bonus_status_desc[$data['status']];
    }
}